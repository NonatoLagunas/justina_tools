 ...
 *
 * Perform the robot arm tasks by calling to the corresponding nodes with 
 * justina-standard srv files. The operation of the services is based on the 
 * original justina_tools created by Marco Negrete.
 * 
